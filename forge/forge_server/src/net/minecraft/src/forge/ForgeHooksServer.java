...
public class ForgeHooksServer
{
	...
	public static LinkedList<ICanPlaceBlockHandler> canPlaceBlockHandlers = new LinkedList<ICanPlaceBlockHandler>();
	...
	public static LinkedList<ICanMineBlockHandler> onMineBlockHandlers = new LinkedList<ICanMineBlockHandler>();
