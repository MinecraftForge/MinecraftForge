...
public class WorldGenHugeTrees extends WorldGenerator
{
    ...
    public WorldGenHugeTrees(boolean par1, int par2, int par3, int par4)
    {
        ...
        this.field_48193_b = par3;
        this.field_48194_c = par4;
    }
                ...
                if ((var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && par4 < 256 - var6 - 1)
                {
                    ...
                    for (int var14 = par4 + var6 - 2 - par2Random.nextInt(4); var14 > par4 + var6 / 2; var14 -= 2 + par2Random.nextInt(4))
                    {
                        ...
                        for (int var13 = 0; var13 < 5; ++var13)
                        {
                            ...
                            this.setBlockAndMetadata(par1World, var11, var14 - 3 + var13 / 2, var12, Block.wood.blockID, this.field_48193_b);
                        }
                    }
                    ...
                    for (var10 = 0; var10 < var6; ++var10)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + var10, par5, Block.wood.blockID, this.field_48193_b);
                        ...
                        if (var10 < var6 - 1)
                        {
                            ...
                            if (var11 == 0 || var11 == Block.leaves.blockID)
                            {
                                this.setBlockAndMetadata(par1World, par3 + 1, par4 + var10, par5, Block.wood.blockID, this.field_48193_b);
                            ...
                            if (var11 == 0 || var11 == Block.leaves.blockID)
                            {
                                this.setBlockAndMetadata(par1World, par3 + 1, par4 + var10, par5 + 1, Block.wood.blockID, this.field_48193_b);
                            ...
                            if (var11 == 0 || var11 == Block.leaves.blockID)
                            {
                                this.setBlockAndMetadata(par1World, par3, par4 + var10, par5 + 1, Block.wood.blockID, this.field_48193_b);
        ...
        for (int var8 = par4 - var7; var8 <= par4; ++var8)
        {
            ...
            for (int var11 = par2 - var10; var11 <= par2 + var10 + 1; ++var11)
            {
                ...
                for (int var13 = par3 - var10; var13 <= par3 + var10 + 1; ++var13)
                {
                    ...
                    {
                        this.setBlockAndMetadata(par1World, var11, var8, var13, Block.leaves.blockID, this.field_48194_c);
                    }
                }
            }
        }
