...
public class EntityOcelot extends EntityTameable
{
    ...
    public EntityOcelot(World par1World)
    {
        ...
        this.tasks.addTask(3, this.field_48149_b = new EntityAITempt(this, 0.18F, Item.fishRaw.shiftedIndex, true));
    ...
    public void updateAITick()
    {
        ...
        {
            float var1 = this.getMoveHelper().func_48184_b();
    ...
    {
        return this.isTamed() ? (this.func_48136_o_() ? "mob.cat.purr" : (this.rand.nextInt(4) == 0 ? "mob.cat.purreow" : "mob.cat.meow")) : "";
    }
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (!this.isTamed())
        {
            if (this.field_48149_b.func_48270_h() && var2 != null && var2.itemID == Item.fishRaw.shiftedIndex && par1EntityPlayer.getDistanceSqToEntity(this) < 9.0D)
            {
                --var2.stackSize;
    ...
    public boolean func_48135_b(EntityAnimal par1EntityAnimal)
    {
        ...
        else
        {
            ...
            return !var2.isTamed() ? false : this.func_48136_o_() && var2.func_48136_o_();
        }
    }
