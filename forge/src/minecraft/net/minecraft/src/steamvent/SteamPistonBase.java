...
public class SteamPistonBase extends BlockPistonBase
{
    /** This pistons is the sticky one? */
    private boolean isSticky;
    private static boolean ignoreUpdates;

    public SteamPistonBase(int par1, int par2, boolean par3)
    {
     ...
     * called by TileEntityRendererPiston.renderPiston() because SteamPistonLogic.shouldRenderHead() will always return
     * false.
     */
    ...
    public void powerBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        else if (par5 == 1)
        {
            ...
            if (var8 != null && var8 instanceof SteamPistonLogic)
            {
                ((SteamPistonLogic)var8).clearPistonTileEntity();
            }

            par1World.setBlockAndMetadata(par2, par3, par4, mod_Steamvent.steamPistonMoving.blockID, par6);
            par1World.setBlockTileEntity(par2, par3, par4, SteamPistonMoving.getTileEntity(this.blockID, par6, par6, false, true));
            ...
            if (this.isSticky)
            {
                ...
                if (var12 == mod_Steamvent.steamPistonMoving.blockID)
                {
                    TileEntity var15 = par1World.getBlockTileEntity(var9, var10, var11);

                    if (var15 != null && var15 instanceof SteamPistonLogic)
                    {
                        SteamPistonLogic var16 = (SteamPistonLogic)var15;
                ...
                if (!var14 && var12 > 0 && canPushBlock(var12, par1World, var9, var10, var11, false) && (Block.blocksList[var12].getMobilityFlag() == 0 || var12 == Block.pistonBase.blockID || var12 == Block.pistonStickyBase.blockID))
                {
                    ...
                    par1World.setBlockAndMetadata(par2, par3, par4, mod_Steamvent.steamPistonMoving.blockID, var13);
                    par1World.setBlockTileEntity(par2, par3, par4, SteamPistonMoving.getTileEntity(var12, var13, par6, false, false));
                    ignoreUpdates = false;
    ...
    private boolean tryExtend(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        while (true)
        {
            ...
            while (var6 != par2 || var7 != par3 || var8 != par4)
            {
                ...
                {
                    par1World.setBlockAndMetadata(var6, var7, var8, mod_Steamvent.steamPistonMoving.blockID, par5 | (this.isSticky ? 8 : 0));
                    par1World.setBlockTileEntity(var6, var7, var8, SteamPistonMoving.getTileEntity(Block.pistonExtension.blockID, par5 | (this.isSticky ? 8 : 0), par5, true, false));
                }
                else
                {
                    par1World.setBlockAndMetadata(var6, var7, var8, mod_Steamvent.steamPistonMoving.blockID, var13);
                    par1World.setBlockTileEntity(var6, var7, var8, SteamPistonMoving.getTileEntity(var12, var13, par5, true, false));
                }
