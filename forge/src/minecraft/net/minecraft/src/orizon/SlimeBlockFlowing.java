...
public class SlimeBlockFlowing extends LiquidBlockBase
	implements ITextureProvider
{
    public SlimeBlockFlowing(int id, int tex, Material material)
    {
        super(id, material);
        enableStats = false;
   ...
   public void updateTick(World world, int x, int y, int z, Random par5Random)
   {
       ...
       if (par5Random.nextInt(50) == 0) {
           ...
           entityslime.setSlimeSize(par5Random.nextInt(5));
