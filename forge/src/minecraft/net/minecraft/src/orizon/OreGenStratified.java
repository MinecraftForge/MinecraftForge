...
public class OreGenStratified extends WorldGenerator
{
    private int md;
    private int size;
    private boolean alt;

    public OreGenStratified(int metadata, int sizeOfVein, boolean alternate)
    {
        md = metadata;
        size = sizeOfVein;
        alt = alternate;
    ...
    {
    	if(y < 16)
    		return mod_Orizon.mineralOreLow3ID;
    	if(y < 32)
    		return mod_Orizon.mineralOreLow2ID;
    	if(y < 48)
    		return mod_Orizon.mineralOreLow1ID;
    	if(y < 64)
    		return mod_Orizon.mineralOreID;
    	if(y < 80)
    		return mod_Orizon.mineralOreHighID;
    	return 0;
    }
    ...
    {
    	if(y < 16)
    		return mod_Orizon.mineralOreAltLow3ID;
    	if(y < 32)
    		return mod_Orizon.mineralOreAltLow2ID;
    	if(y < 48)
    		return mod_Orizon.mineralOreAltLow1ID;
    	if(y < 64)
    		return mod_Orizon.mineralOreAltID;
    	if(y < 80)
    		return mod_Orizon.mineralOreAltHighID;
    	return 0;
    }
}
