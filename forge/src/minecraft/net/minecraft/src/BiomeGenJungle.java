...
public class BiomeGenJungle extends BiomeGenBase
{
    ...
    {
        return (WorldGenerator)(par1Random.nextInt(10) == 0 ? this.worldGenBigTree : (par1Random.nextInt(2) == 0 ? new WorldGenShrub(3, 0) : (par1Random.nextInt(3) == 0 ? new WorldGenHugeTrees(false, 10 + par1Random.nextInt(20), 3, 3) : new WorldGenTreesJungle(false, 4 + par1Random.nextInt(7), 3, 3, true))));
    }
