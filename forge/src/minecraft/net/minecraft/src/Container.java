...
public abstract class Container
{
            ...
            if (par2 == 0 || par2 == 1)
            {
                ...
                if (par1 == -999)
                {
                    if (var6.getItemStack() != null && par1 == -999)
                    {
                        if (par2 == 0)
                        {
                            par4EntityPlayer.func_48153_a(var6.getItemStack());
                            var6.setItemStack((ItemStack)null);
                        }

                        if (par2 == 1)
                        {
                            par4EntityPlayer.func_48153_a(var6.getItemStack().splitStack(1));
    ...
    public void onCraftGuiClosed(EntityPlayer par1EntityPlayer)
    {
        ...
        {
            par1EntityPlayer.func_48153_a(var2.getItemStack());
