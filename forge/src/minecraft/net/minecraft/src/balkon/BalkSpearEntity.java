...
public class BalkSpearEntity extends Entity
{
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public BalkSpearEntity(World world)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public BalkSpearEntity(World world, double d, double d1, double d2)
    {
        super(world);
        xTile = -1;
        yTile = -1;
    ...
    public BalkSpearEntity(World world, EntityLiving entityliving, ItemStack itemstack, int i)
    {
        super(world);
        ...
        setArrowHeading(motionX, motionY, motionZ, 0.6F, 6F);
    }
    ...
    public void writeEntityToNBT(NBTTagCompound nbttagcompound)
    {
        ...
        nbttagcompound.setInteger("item", itemID);
    }
