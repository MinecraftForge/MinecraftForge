...
public class WhiteWoodBoat extends Entity
{
    ...
    public WhiteWoodBoat(World world)
    {
        this(world, 0);
    }
    
    public WhiteWoodBoat(World world, int metadata)
    {
        super(world);
    ...
    public WhiteWoodBoat(World world, double d, double d1, double d2)
    {
        this(world);
    ...
    public void onUpdate()
    {
        ...
        if (list != null && list.size() > 0)
        {
            for (int j1 = 0; j1 < list.size(); j1++)
            {
                ...
                if (entity != riddenByEntity && entity.canBePushed() && (entity instanceof WhiteWoodBoat))
                {
