...
{
    /**
     * An array of 37 item stacks (but only filled with 36?) indicating the main player inventory (including the visible
     * bar).
     */
    ...
    public boolean addItemStackToInventory(ItemStack par1ItemStack)
    {
        ...
        else
        {
            ...
            if (par1ItemStack.stackSize == var2 && this.player.capabilities.depleteBuckets)
            {
                par1ItemStack.stackSize = 0;
                return true;
            }
    ...
    public void dropAllItems()
    {
        ...
        for (var1 = 0; var1 < this.mainInventory.length; ++var1)
        {
            if (this.mainInventory[var1] != null)
            {
                this.player.func_48151_a(this.mainInventory[var1], true);
        ...
        for (var1 = 0; var1 < this.armorInventory.length; ++var1)
        {
            ...
            {
                this.player.func_48151_a(this.armorInventory[var1], true);
