...
public class BlockDoor extends Block
{
    ...
    {
        int var5 = this.func_48134_e(par1IBlockAccess, par2, par3, par4);
        return (var5 & 4) != 0;
    }
    ...
    {
        this.setDoorRotation(this.func_48134_e(par1IBlockAccess, par2, par3, par4));
    }

    public int getDoorOrientation(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
    {
        return this.func_48134_e(par1IBlockAccess, par2, par3, par4) & 3;
    }

    public boolean func_48135_d(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
    {
        return (this.func_48134_e(par1IBlockAccess, par2, par3, par4) & 4) != 0;
    }
    ...
    public boolean blockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer)
    {
        ...
        {
            int var6 = this.func_48134_e(par1World, par2, par3, par4);
            int var7 = var6 & 7;
            var7 ^= 4;
