...
public class BalkToolBattleaxe extends InfiWeaponBase
    implements ITextureProvider
{
    ...
    public BalkToolBattleaxe(int i, int j, int k, float f, int l, int i1, int j1)
    {
    ...
    {
        return "/infibalkon/balkbattleaxes.png";
    }
