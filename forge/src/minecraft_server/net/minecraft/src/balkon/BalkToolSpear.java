...
public class BalkToolSpear extends InfiWeaponBase
    implements ITextureProvider
{
    ...
    public BalkToolSpear(int i, int j, int k, int l, int i1)
    {
    ...
    public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entityplayer)
    {
        ...
        if (!world.isRemote)
        {
            world.spawnEntityInWorld(new BalkSpearEntity(world, entityplayer, itemstack, weaponDamage));
        }
    ...
    {
        return "/infibalkon/balkspears.png";
    }
