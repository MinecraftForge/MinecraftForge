...
public class InfiToolShovel extends InfiToolBase
    implements ITextureProvider
{
    private static Material materialEffectiveAgainst[];
    private static Random random = new Random();

    public InfiToolShovel(int i, int j, int k, float f, int l, int i1, int j1)
    {
        super(i, 1, j, k, f, l, true, materialEffectiveAgainst, i1, j1);
    }
    ...
    {
        return "/infitools/infishovels.png";
    }
