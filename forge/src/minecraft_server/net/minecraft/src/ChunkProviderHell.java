...
public class ChunkProviderHell implements IChunkProvider
{
    ...
    public void func_4061_b(int par1, int par2, byte[] par3ArrayOfByte)
    {
        ...
        this.field_4233_p = this.field_4237_l.generateNoiseOctaves(this.field_4233_p, par1 * 16, par2 * 16, 0, 16, 16, 1, var5, var5, 1.0D);
        this.gravelNoise = this.field_4237_l.generateNoiseOctaves(this.gravelNoise, par1 * 16, 109, par2 * 16, 16, 1, 16, var5, 1.0D, var5);
        this.field_4231_r = this.field_4236_m.generateNoiseOctaves(this.field_4231_r, par1 * 16, par2 * 16, 0, 16, 16, 1, var5 * 2.0D, var5 * 2.0D, var5 * 2.0D);
    ...
    private double[] func_4060_a(double[] par1ArrayOfDouble, int par2, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        this.field_4243_f = this.field_4248_a.generateNoiseOctaves(this.field_4243_f, par2, par3, par4, par5, 1, par7, 1.0D, 0.0D, 1.0D);
        this.field_4242_g = this.field_4247_b.generateNoiseOctaves(this.field_4242_g, par2, par3, par4, par5, 1, par7, 100.0D, 0.0D, 100.0D);
        this.field_4246_c = this.field_4238_k.generateNoiseOctaves(this.field_4246_c, par2, par3, par4, par5, par6, par7, var8 / 80.0D, var10 / 60.0D, var8 / 80.0D);
        this.field_4245_d = this.field_4240_i.generateNoiseOctaves(this.field_4245_d, par2, par3, par4, par5, par6, par7, var8, var10, var8);
        this.field_4244_e = this.field_4239_j.generateNoiseOctaves(this.field_4244_e, par2, par3, par4, par5, par6, par7, var8, var10, var8);
        int var12 = 0;
        int var13 = 0;
