...
public class MapGenStronghold extends MapGenStructure
{
    ...
    protected StructureStart getStructureStart(int par1, int par2)
    {
        ...
        for (var3 = new StructureStrongholdStart(this.worldObj, this.rand, par1, par2); var3.getComponents().isEmpty() || ((ComponentStrongholdStairs2)var3.getComponents().get(0)).field_40317_b == null; var3 = new StructureStrongholdStart(this.worldObj, this.rand, par1, par2))
        {
            ;
        }
