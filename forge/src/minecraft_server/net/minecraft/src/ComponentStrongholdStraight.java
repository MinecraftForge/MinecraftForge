...
public class ComponentStrongholdStraight extends ComponentStronghold
{
    ...
    public ComponentStrongholdStraight(int par1, Random par2Random, StructureBoundingBox par3StructureBoundingBox, int par4)
    {
        ...
        this.field_35341_a = this.getRandomDoor(par2Random);
        this.boundingBox = par3StructureBoundingBox;
        this.field_35339_b = par2Random.nextInt(2) == 0;
        this.field_35340_c = par2Random.nextInt(2) == 0;
    }
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        else
        {
            ...
            this.placeDoor(par1World, par2Random, par3StructureBoundingBox, this.field_35341_a, 1, 1, 0);
