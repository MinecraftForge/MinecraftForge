...
public class ChunkProviderEnd implements IChunkProvider
{
    ...
    private double[] func_40186_a(double[] par1ArrayOfDouble, int par2, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        this.field_40187_f = this.field_40193_a.generateNoiseOctaves(this.field_40187_f, par2, par4, par5, par7, 1.121D, 1.121D, 0.5D);
        this.field_40188_g = this.field_40191_b.generateNoiseOctaves(this.field_40188_g, par2, par4, par5, par7, 200.0D, 200.0D, 0.5D);
        var8 *= 2.0D;
        this.field_40192_c = this.field_40196_l.generateNoiseOctaves(this.field_40192_c, par2, par3, par4, par5, par6, par7, var8 / 80.0D, var10 / 160.0D, var8 / 80.0D);
        this.field_40189_d = this.field_40198_j.generateNoiseOctaves(this.field_40189_d, par2, par3, par4, par5, par6, par7, var8, var10, var8);
        this.field_40190_e = this.field_40199_k.generateNoiseOctaves(this.field_40190_e, par2, par3, par4, par5, par6, par7, var8, var10, var8);
        int var12 = 0;
        int var13 = 0;
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        int var4 = par2 * 16;
        int var5 = par3 * 16;
        BiomeGenBase var6 = this.endWorld.func_48091_a(var4 + 16, var5 + 16);
    ...
    {
        BiomeGenBase var5 = this.endWorld.func_48091_a(par2, par4);
