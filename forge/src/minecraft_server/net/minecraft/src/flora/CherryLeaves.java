...
public class CherryLeaves extends BlockLeavesBase
    implements ITextureProvider
{
    private int baseIndexInPNG;
    int adjacentTreeBlocks[];

    public CherryLeaves(int i, int j)
    {
    ...
    {
        arraylist.add(new ItemStack(mod_FloraSoma.cherryLeaves, 1, 0));
        arraylist.add(new ItemStack(mod_FloraSoma.cherryLeaves, 1, 1));
    }
}
