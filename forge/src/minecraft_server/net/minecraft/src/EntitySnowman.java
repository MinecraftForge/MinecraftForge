...
public class EntitySnowman extends EntityGolem
{
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.worldObj.func_48091_a(var1, var2).getFloatTemperature() > 1.0F)
        {
        ...
        for (var1 = 0; var1 < 4; ++var1)
        {
            ...
            if (this.worldObj.getBlockId(var2, var3, var4) == 0 && this.worldObj.func_48091_a(var2, var4).getFloatTemperature() < 0.8F && Block.snow.canPlaceBlockAt(this.worldObj, var2, var3, var4))
            {
