...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO
{
    ...
    public Chunk loadChunk(World par1World, int par2, int par3) throws IOException
    {
        ...
        if (var4 == null)
        {
            DataInputStream var10 = RegionFileCache.getChunkInputStream(this.field_48466_d, par2, par3);
    ...
    protected Chunk func_48464_a(World par1World, int par2, int par3, NBTTagCompound par4NBTTagCompound)
    {
        ...
        {
            Chunk var5 = this.func_48465_a(par1World, par4NBTTagCompound.getCompoundTag("Level"));
            ...
            if (!var5.isAtLocation(par2, par3))
            {
                ...
                var5 = this.func_48465_a(par1World, par4NBTTagCompound.getCompoundTag("Level"));
            }
    ...
    {
        DataOutputStream var2 = RegionFileCache.getChunkOutputStream(this.field_48466_d, par1AnvilChunkLoaderPending.field_48581_a.chunkXPos, par1AnvilChunkLoaderPending.field_48581_a.chunkZPos);
    ...
    private void func_48462_a(Chunk par1Chunk, World par2World, NBTTagCompound par3NBTTagCompound)
    {
        ...
        for (int var8 = 0; var8 < var7; ++var8)
        {
            ...
            if (var9 != null && var9.func_48587_f() != 0)
            {
                ...
                var10.setByte("Y", (byte)(var9.func_48597_c() >> 4 & 255));
                var10.setByteArray("Blocks", var9.func_48590_g());

                if (var9.func_48601_h() != null)
                {
                    var10.setByteArray("Add", var9.func_48601_h().data);
                }

                var10.setByteArray("Data", var9.func_48594_i().data);
                var10.setByteArray("SkyLight", var9.func_48605_k().data);
                var10.setByteArray("BlockLight", var9.func_48600_j().data);
        ...
        for (var7 = 0; var7 < par1Chunk.field_48563_j.length; ++var7)
        {
            var17 = par1Chunk.field_48563_j[var7].iterator();
    ...
    private Chunk func_48465_a(World par1World, NBTTagCompound par2NBTTagCompound)
    {
        ...
        var5.field_48562_f = par2NBTTagCompound.func_48445_l("HeightMap");
        ...
        for (int var9 = 0; var9 < var6.tagCount(); ++var9)
        {
            ...
            var12.func_48596_a(var10.getByteArray("Blocks"));

            if (var10.hasKey("Add"))
            {
                var12.func_48593_a(new NibbleArray(var10.getByteArray("Add"), 4));
            }

            var12.func_48586_b(new NibbleArray(var10.getByteArray("Data"), 4));
            var12.func_48589_d(new NibbleArray(var10.getByteArray("SkyLight"), 4));
            var12.func_48606_c(new NibbleArray(var10.getByteArray("BlockLight"), 4));
            var12.func_48599_d();
            var8[var11] = var12;
        }

        var5.func_48558_a(var8);

        if (par2NBTTagCompound.hasKey("Biomes"))
        {
            var5.func_48559_a(par2NBTTagCompound.getByteArray("Biomes"));
        }
