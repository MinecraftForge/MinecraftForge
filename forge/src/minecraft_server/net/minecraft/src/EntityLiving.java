...
public abstract class EntityLiving extends Entity
{
    ...
    private EntityLiving field_48338_d = null;
    ...
    public EntityLiving(World par1World)
    {
        ...
        this.field_48344_j = new EntityBodyHelper(this);
    ...
    public void func_48335_g(Entity par1Entity)
    {
        ...
        {
            this.field_48338_d = (EntityLiving)par1Entity;
        }
    }
    ...
    public void onEntityUpdate()
    {
        ...
        if (this.field_48338_d != null && !this.field_48338_d.isEntityAlive())
        {
            this.field_48338_d = null;
        }
    ...
    public void onUpdate()
    {
        ...
        if (this.isAIEnabled())
        {
            this.field_48344_j.func_48431_a();
        }
        else
        {
            float var9;
    ...
    protected void updateAITasks()
    {
        ...
        this.field_48343_m.func_48547_a();
        Profiler.endSection();
