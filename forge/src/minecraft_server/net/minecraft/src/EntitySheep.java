...
public class EntitySheep extends EntityAnimal implements IShearable
{
    ...
    private EntityAIEatGrass field_48365_c = new EntityAIEatGrass(this);
    ...
    public EntitySheep(World par1World)
    {
        ...
        this.tasks.addTask(5, this.field_48365_c);
    ...
    {
        this.sheepTimer = this.field_48365_c.func_48227_f();
        super.updateAITasks();
    }
