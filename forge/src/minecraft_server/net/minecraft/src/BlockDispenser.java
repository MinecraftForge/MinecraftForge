        ...
        if (var9 != null)
        {
            ...
            else
            {
                ...
                if (!var17)
                {
                    ...
                    else if (var10.itemID == Item.field_48389_bC.shiftedIndex)
                    {
                    ...
                    {
                        ItemMonsterPlacer.func_48390_a(par1World, var10.getItemDamage(), var11 + (double)var7 * 0.3D, var13 - 0.3D, var15 + (double)var8 * 0.3D);
                        par1World.playAuxSFX(1002, par2, par3, par4, 0);
                    }
                    else if (var10.itemID == Item.field_48388_bD.shiftedIndex)
                    {
