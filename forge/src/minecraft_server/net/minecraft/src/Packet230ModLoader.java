...
public class Packet230ModLoader extends Packet
{
    ...
    {
        EntityPlayerMP var2 = null;

        if (playerMap.containsKey(var1))
        {
            var2 = (EntityPlayerMP)playerMap.get(var1);
        }
        else if (var1 instanceof NetServerHandler)
        {
            try
            {
                var2 = (EntityPlayerMP)ModLoader.getPrivateValue(NetServerHandler.class, var1, 4);
            }
        ...
        ModLoaderMp.handleAllPackets(this, var2);
    }
