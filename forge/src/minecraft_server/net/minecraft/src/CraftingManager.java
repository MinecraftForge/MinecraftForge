...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        this.addShapelessRecipe(new ItemStack(Item.field_48388_bD, 3), new Object[] {Item.gunpowder, Item.blazePowder, Item.coal});
        this.addShapelessRecipe(new ItemStack(Item.field_48388_bD, 3), new Object[] {Item.gunpowder, Item.blazePowder, new ItemStack(Item.coal, 1, 1)});
