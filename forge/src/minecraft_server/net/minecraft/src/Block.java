...
public class Block
{
    ...
    public static final Block field_48130_bL = (new BlockRedstoneLight(123, false)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("redstoneLight");
    public static final Block field_48131_bM = (new BlockRedstoneLight(124, true)).setHardness(0.3F).setStepSound(soundGlassFootstep).setBlockName("redstoneLight");
    ...
    {
        this.field_48129_bT = par1;
        return this;
    }

    public boolean func_48125_m()
    {
        return this.field_48129_bT;
    }
