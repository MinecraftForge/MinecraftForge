...
public class WorldGenTrees extends WorldGenerator
{
    ...
    {
        super(par1);
        this.field_48402_a = par2;
        this.field_48401_c = par3;
        this.field_48399_d = par4;
        this.field_48400_b = par5;
    }

    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        int var6 = par2Random.nextInt(3) + this.field_48402_a;
        boolean var7 = true;
            ...
            else
            {
                ...
                if ((var8 == Block.grass.blockID || var8 == Block.dirt.blockID) && par4 < 256 - var6 - 1)
                {
                    ...
                    for (var11 = par4 - var9 + var6; var11 <= par4 + var6; ++var11)
                    {
                        ...
                        for (var14 = par3 - var13; var14 <= par3 + var13; ++var14)
                        {
                            ...
                            for (int var16 = par5 - var13; var16 <= par5 + var13; ++var16)
                            {
                                ...
                                {
                                    this.setBlockAndMetadata(par1World, var14, var11, var16, Block.leaves.blockID, this.field_48399_d);
                                }
                            }
                        }
                    }
                    ...
                    for (var11 = 0; var11 < var6; ++var11)
                    {
                        ...
                        {
                            this.setBlockAndMetadata(par1World, par3, par4 + var11, par5, Block.wood.blockID, this.field_48401_c);

                            if (this.field_48400_b && var11 > 0)
                            {
