...
public class NetServerHandler extends NetHandler implements ICommandListener
{
    ...
    public void handleBlockDig(Packet14BlockDig par1Packet14BlockDig)
    {
        ...
        {
            this.playerEntity.func_48347_R();
        }
    ...
    public void handleChat(Packet3Chat par1Packet3Chat)
    {
        ...
        else
        {
            ...
            {
                if (!ChatAllowedCharacters.func_48409_a(var2.charAt(var3)))
                {
    ...
    private void handleSlashCommand(String par1Str)
    {
        ...
        else if (ModLoaderMp.handleCommand(par1Str.substring(1), this.playerEntity.username, logger, this.mcServer.configManager.isOp(this.playerEntity.username)))
        {
    ...
    {
        WorldServer var2 = this.mcServer.getWorldManager(this.playerEntity.dimension);
        Entity var3 = var2.func_6158_a(par1Packet7UseEntity.targetEntity);
    ...
    public void handleCreativeSetSlot(Packet107CreativeSetSlot par1Packet107CreativeSetSlot)
    {
        if (this.playerEntity.itemInWorldManager.isCreative())
        {
            ...
            else if (var2 && var5 && var6 && this.field_48073_n < 200)
            {
                ...
                EntityItem var7 = this.playerEntity.func_48348_b(var3);
