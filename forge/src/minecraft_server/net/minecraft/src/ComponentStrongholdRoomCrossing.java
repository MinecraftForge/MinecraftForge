...
public class ComponentStrongholdRoomCrossing extends ComponentStronghold
{
    ...
    public ComponentStrongholdRoomCrossing(int par1, Random par2Random, StructureBoundingBox par3StructureBoundingBox, int par4)
    {
        ...
        this.field_35347_b = par2Random.nextInt(5);
    }
        ...
        else
        {
            ...
            switch (this.field_35347_b)
            {
                ...
                case 2:
                    ...
                    this.createTreasureChestAtCurrentPosition(par1World, par3StructureBoundingBox, par2Random, 3, 4, 8, field_35348_c, 1 + par2Random.nextInt(4));
            }
