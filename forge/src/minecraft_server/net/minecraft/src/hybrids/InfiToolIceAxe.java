...
public class InfiToolIceAxe extends InfiToolBase
    implements ITextureProvider
{
    ...
    public InfiToolIceAxe(int i, int j, int k, float f, int l, int i1, int j1)
    {
    ...
    public boolean onBlockDestroyed(ItemStack itemstack, int i, int j, int k, int l, EntityLiving entityliving)
    {
        ...
        if (i == Block.oreIron.blockID || i == Block.oreGold.blockID || i == Block.oreDiamond.blockID || i == Block.oreLapis.blockID || i == Block.oreRedstone.blockID || i == Block.oreRedstoneGlowing.blockID)
        {
            itemstack.damageItem(1, entityliving);
        }
        return true;
            ...
            int i1, int j1)
    {
        switch (j1)
        {
            ...
            case 14:
                InfiHybridPowers.freezingIceAxe(j, k, l, i, i1, world, entityliving);
                break;
    ...
    {
        return "/infihybrids/infiiceaxes.png";
    }
