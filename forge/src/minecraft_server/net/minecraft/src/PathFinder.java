...
public class PathFinder
{
    ...
    public PathFinder(IBlockAccess par1IBlockAccess, boolean par2, boolean par3, boolean par4, boolean par5)
    {
        ...
        this.field_48412_e = par2;
        this.field_48410_f = par3;
        this.field_48411_g = par4;
        this.field_48413_h = par5;
    }
    ...
    private PathEntity createEntityPathTo(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        boolean var9 = this.field_48411_g;
        int var10 = MathHelper.floor_double(par1Entity.boundingBox.minY + 0.5D);

        if (this.field_48413_h && par1Entity.isInWater())
        {
            ...
            var9 = this.field_48411_g;
            this.field_48411_g = false;
        }
        else
        {
            ...
            for (int var8 = par3; var8 < par3 + par5PathPoint.yCoord; ++var8)
            {
                for (int var9 = par4; var9 < par4 + par5PathPoint.zCoord; ++var9)
                {
                    ...
                    if (var10 > 0)
                    {
                        ...
                        {
                            if (!this.field_48412_e && var10 == Block.doorWood.blockID)
                            {
                                return 0;
                            }
                        }
                        ...
                        if (!var11.func_48127_b(this.worldMap, var7, var8, var9) && (!this.field_48410_f || var10 != Block.doorWood.blockID))
                        {
