...
public interface ICustomSaveHandler
{
	/**
	 ...
	 * @param nbttagcompound The compound to save data into and be written to disk
	 */
	public void saveChunkData(World world, Chunk chunk, NBTTagCompound nbttagcompound);

	/**
	 * Use this to load extra save data from a chunk file.
	 * @param world The world containing this chunk.
	 * @param chunk The chunk being loaded.
	 * @param nbttagcompound The compound to load data from
	 */
	public void loadChunkData(World world, Chunk chunk, NBTTagCompound nbttagcompound);
}
