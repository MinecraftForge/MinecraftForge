...
Download the latest Forge source distribution from http://files.minecraftforge.net and unzip it to a folder.2. 
...
**Note: If you wish to use the Eclipse IDE, run gradle eclipse instead of gradle setupDevWorkspace, or install the Gradle plugin for Eclipse and import the Forge source folder as a Gradle proect.**


#For Contributors: 
This assumes you have Gradle installed. If you don't, use the following command:
...
##Requirements (for both mod devs and contributors):
  ...
  If you do not wish to use the gradle wrapper, you can install Gradle [here](http://www.gradle.org/).
