...
public class GuiModList extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.field_146292_n.add(new GuiButton(6, this.field_146294_l / 2 - 75, this.field_146295_m - 38, I18n.getStringParams("gui.done")));
    ...
    {
        this.field_146289_q.drawString(line, offset, shifty, 0xd7edea);
        return shifty + 10;
    }
    ...
    public void drawScreen(int p_571_1_, int p_571_2_, float p_571_3_)
    {
        ...
        this.drawCenteredString(this.field_146289_q, "Mod List", this.field_146294_l / 2, 16, 0xFFFFFF);
        ...
        if (selectedMod != null) {
            ...
            if (!selectedMod.getMetadata().autogenerated) {
                ...
                if (!logoFile.isEmpty())
                {
                    ...
                    TextureManager tm = field_146297_k.getTextureManager();
                    ...
                    try
                    {
                        ...
                        if (cachedLogo != null)
                        {
                            this.field_146297_k.renderEngine.bindTexture(cachedLogo);
                ...
                this.field_146289_q.drawStringWithShadow(selectedMod.getMetadata().name, offset, shifty, 0xFFFFFF);
                shifty += 12;
                ...
                this.drawCenteredString(this.field_146289_q, selectedMod.getName(), offset, 35, 0xFFFFFF);
                this.drawCenteredString(this.field_146289_q, String.format("Version: %s",selectedMod.getVersion()), offset, 45, 0xFFFFFF);
                this.drawCenteredString(this.field_146289_q, String.format("Mod State: %s",Loader.instance().getModState(selectedMod)), offset, 55, 0xFFFFFF);
                this.drawCenteredString(this.field_146289_q, "No mod information found", offset, 65, 0xDDDDDD);
                this.drawCenteredString(this.field_146289_q, "Ask your mod author to provide a mod mcmod.info file", offset, 75, 0xDDDDDD);
