...
public class ClientRegistry
{
     ...
     */
    public static <T extends TileEntity> void registerTileEntity(Class <? extends T> tileEntityClass, String id, TileEntitySpecialRenderer<? super T> specialRenderer)
    {
        GameRegistry.registerTileEntity(tileEntityClass, id);
        bindTileEntitySpecialRenderer(tileEntityClass, specialRenderer);
    }

    public static <T extends TileEntity> void bindTileEntitySpecialRenderer(Class <? extends T> tileEntityClass, TileEntitySpecialRenderer<? super T> specialRenderer)
    {
