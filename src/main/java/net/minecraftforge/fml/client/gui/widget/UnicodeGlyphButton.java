...
public class UnicodeGlyphButton extends ExtendedButton
{
    ...
    public void render(int mouseX, int mouseY, float partial)
    {
        if (this.visible)
        {
            ...
            GuiUtils.drawContinuousTexturedBox(Button.WIDGETS_LOCATION, this.x, this.y, 0, 46 + k * 20, this.width, this.height, 200, 20, 2, 3, 2, 2, this.getBlitOffset(), this.alpha);
