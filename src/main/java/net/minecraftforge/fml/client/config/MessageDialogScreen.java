...
public class MessageDialogScreen extends Screen {
	...
	protected void init() {
		...
		this.addButton(new GuiButtonExt(this.width / 2 - 100, Math.min(this.height / 2 + this.messageHeight / 2 + 9, this.height - 30), 200, 20, buttonText, button -> this.minecraft.displayGuiScreen(this.nextScreen)));
	}
