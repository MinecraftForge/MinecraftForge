...
import static net.minecraftforge.fml.client.gui.GuiUtils.RESET_CHAR;
...
public class ConfigScreen extends Screen {
	...
	/**
	 * The number of milliseconds for the threshold of HoverCheckers on ConfigScreens.
	 */
	public static final int HOVER_THRESHOLD = 500;
	 ...
	 */
	protected ExtendedButton undoChangesButton;
	/**
	 ...
	 */
	protected ExtendedButton resetToDefaultButton;
	/**
	...
	public void init() {
		...
		this.addButton(new ExtendedButton(xPos, yPos, doneWidth, BUTTON_HEIGHT, doneText, this::onDoneButtonClicked));

		xPos += doneWidth + MARGIN;
		this.addButton(undoChangesButton = new UnicodeGlyphButton(xPos, yPos, undoWidth, BUTTON_HEIGHT, undoText, UNDO_CHAR, 2.0F, this::onUndoChangesButtonClicked));

		xPos += undoWidth + MARGIN;
		this.addButton(resetToDefaultButton = new UnicodeGlyphButton(xPos, yPos, resetWidth, BUTTON_HEIGHT, resetText, RESET_CHAR, 2.0F, this::onResetToDefaultButtonClicked));
		...
		this.undoChangesButtonHoverChecker = new HoverChecker(undoChangesButton, HOVER_THRESHOLD);
		this.resetToDefaultButtonHoverChecker = new HoverChecker(resetToDefaultButton, HOVER_THRESHOLD);
		this.applyToSubcategoriesCheckBoxHoverChecker = new HoverChecker(applyToSubcategoriesCheckBox, HOVER_THRESHOLD);
