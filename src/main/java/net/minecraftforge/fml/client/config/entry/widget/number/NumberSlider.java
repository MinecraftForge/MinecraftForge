...
/**
 * {@link Slider} for a {@link Number}
 *
 * @author Cadiboo
 */
public abstract class NumberSlider<T extends Number & Comparable<? super T>> extends Slider implements IConfigListEntryWidget<T> {
	...
	public abstract T getValue(Slider slider);
