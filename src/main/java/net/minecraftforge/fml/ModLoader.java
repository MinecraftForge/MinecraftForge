...
import net.minecraftforge.fml.client.MessageConsumer;
...
public class ModLoader
{
    ...
    private Optional<MessageConsumer> statusConsumer = Optional.empty();
    ...
    public void finishMods(Executor mainThreadExecutor)
    {
        ...
        statusConsumer.ifPresent(c->c.accept("Loading done. Have fun!"));
    }
    ...
    public void setStatusConsumer(MessageConsumer consumer) {
