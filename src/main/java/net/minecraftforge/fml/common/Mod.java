...
public @interface Mod
{
     ...
     *
     * A dependency string can start with a combination of these prefixes, separated by "-":
     ...
     *         "required:forge@[14.21.1.2395,);required-after:mod1;mod2@[4.7.0,);required-client:rendermod;"
     *
