...
public class VillagerRegistry
{
    ...
    {
        professions.add(id, prof.name, prof);
    }

    private boolean hasInit = false;
    public FMLControlledNamespacedRegistry<VillagerProfession> professions = PersistentRegistryManager.createRegistry(new ResourceLocation("minecraft:villagerprofessions"), VillagerProfession.class, null, 1024, 0, true);
    ...
    {
        ArrayList<ResourceLocation> entries = new ArrayList<ResourceLocation>(INSTANCE.professions.getKeys());
    ...
    {
        VillagerProfession profession = INSTANCE.professions.getObject(new ResourceLocation(professionID));
        if(profession == null)
        {
            return INSTANCE.professions.getObjectById(0);
        }
    ...
    public static String getVillagerDisplay(EntityVillager entity)
    {
        ...
        int careerId = entity.getCareer();
        VillagerCareer career = profession.careers.get((careerId - 1)%profession.getCareerCount());
        return career.name;
    }
