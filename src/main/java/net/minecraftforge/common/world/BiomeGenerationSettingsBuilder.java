...
import net.minecraftforge.mixin.MixinBiomeGenerationSettingsAccessor;
...
public class BiomeGenerationSettingsBuilder extends BiomeGenerationSettings.Builder {
    public BiomeGenerationSettingsBuilder(BiomeGenerationSettings orig) {
        ...
        ((MixinBiomeGenerationSettingsAccessor)orig).getField_242483_e().forEach((k, l) -> field_242505_b.put(k, new ArrayList<>(l)));
