...
public interface IHarvestablePlant extends IPlant
{
     ...
     * block is up to the implementation. Some blocks may be destroyed on harvest, others may revert to a previous state in the growth process. Auto-replanting should attempt to
