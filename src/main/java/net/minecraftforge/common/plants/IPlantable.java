...
public interface IPlantable
{
     ...
     *            The world.
     * @param pos
     *            The position that this state may attempt to be placed at later.
     * @param stack
     *            The stack, which should contain an instance of this IPlantable.
     * 
     ...
     * 
     * @param state
     *            The state to place, should be equivalent to {@link IPlantable#getPlant(ItemStack, IBlockReader, BlockPos)}.
     * @param world
     *            The world
     * @param pos
