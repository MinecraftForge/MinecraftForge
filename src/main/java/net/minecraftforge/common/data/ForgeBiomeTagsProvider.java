...
public final class ForgeBiomeTagsProvider extends BiomeTagsProvider
{
    ...
    protected void addTags()
    {
        ...
        tag(Biomes.LUSH_CAVES, Tags.Biomes.IS_LUSH, Tags.Biomes.IS_WET_OVERWORLD, Tags.Biomes.IS_CAVE);
        tag(Biomes.DRIPSTONE_CAVES, Tags.Biomes.IS_SPARSE_OVERWORLD, Tags.Biomes.IS_CAVE);
        ...
        tag(Biomes.DEEP_DARK, Tags.Biomes.IS_DEEP, Tags.Biomes.IS_RARE, Tags.Biomes.IS_SPOOKY);
        ...
        tag(Tags.Biomes.IS_UNDERGROUND).addTag(Tags.Biomes.IS_CAVE).addTag(Tags.Biomes.IS_DEEP);
    }
