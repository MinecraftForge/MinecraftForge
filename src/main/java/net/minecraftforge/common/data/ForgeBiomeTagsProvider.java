...
public final class ForgeBiomeTagsProvider extends BiomeTagsProvider
{
    ...
    {
        tag(Biomes.PLAINS, Tags.Biomes.IS_PLAINS, Tags.Biomes.IS_TEMPERATE_OVERWORLD);
        ...
        tag(Biomes.SWAMP, Tags.Biomes.IS_WET_OVERWORLD, Tags.Biomes.IS_SWAMP, Tags.Biomes.IS_TEMPERATE_OVERWORLD);
        ...
        tag(Biomes.MUSHROOM_FIELDS, Tags.Biomes.IS_MUSHROOM, Tags.Biomes.IS_RARE, Tags.Biomes.IS_TEMPERATE_OVERWORLD);
        ...
        tag(Biomes.BEACH, Tags.Biomes.IS_WET_OVERWORLD, Tags.Biomes.IS_SANDY, Tags.Biomes.IS_TEMPERATE_OVERWORLD);
        tag(Biomes.SNOWY_BEACH, Tags.Biomes.IS_COLD_OVERWORLD, Tags.Biomes.IS_SNOWY);
        tag(Biomes.DARK_FOREST, Tags.Biomes.IS_SPOOKY, Tags.Biomes.IS_DENSE_OVERWORLD, Tags.Biomes.IS_TEMPERATE_OVERWORLD);
        ...
        tag(Biomes.MEADOW, Tags.Biomes.IS_PLAINS, Tags.Biomes.IS_PLATEAU, Tags.Biomes.IS_SLOPE, Tags.Biomes.IS_TEMPERATE_OVERWORLD);
        ...
        tag(Biomes.FOREST, Tags.Biomes.IS_TEMPERATE_OVERWORLD);
        tag(Biomes.SUNFLOWER_PLAINS, Tags.Biomes.IS_PLAINS, Tags.Biomes.IS_RARE, Tags.Biomes.IS_TEMPERATE_OVERWORLD);
        tag(Biomes.WINDSWEPT_GRAVELLY_HILLS, Tags.Biomes.IS_SPARSE_OVERWORLD, Tags.Biomes.IS_RARE);
        tag(Biomes.FLOWER_FOREST, Tags.Biomes.IS_RARE, Tags.Biomes.IS_DENSE_OVERWORLD, Tags.Biomes.IS_TEMPERATE_OVERWORLD);
        tag(Biomes.ICE_SPIKES, Tags.Biomes.IS_COLD_OVERWORLD, Tags.Biomes.IS_SNOWY, Tags.Biomes.IS_RARE);
        tag(Biomes.BIRCH_FOREST, Tags.Biomes.IS_TEMPERATE_OVERWORLD, Tags.Biomes.IS_DENSE_OVERWORLD);
        tag(Biomes.OLD_GROWTH_BIRCH_FOREST, Tags.Biomes.IS_DENSE_OVERWORLD, Tags.Biomes.IS_RARE, Tags.Biomes.IS_TEMPERATE_OVERWORLD);
        ...
        tag(Tags.Biomes.IS_TEMPERATE).addTag(Tags.Biomes.IS_TEMPERATE_OVERWORLD);
