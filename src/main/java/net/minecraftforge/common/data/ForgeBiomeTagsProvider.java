...
public final class ForgeBiomeTagsProvider extends BiomeTagsProvider
{
    ...
    protected void addTags()
    {
        ...
        tag(Biomes.BEACH, Tags.Biomes.IS_WET_OVERWORLD, Tags.Biomes.IS_SANDY, Tags.Biomes.IS_BEACH);
        tag(Biomes.SNOWY_BEACH, Tags.Biomes.IS_COLD_OVERWORLD, Tags.Biomes.IS_SNOWY, Tags.Biomes.IS_BEACH);
        tag(Biomes.STONY_SHORE, Tags.Biomes.IS_BEACH);
