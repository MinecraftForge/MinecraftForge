...
/**
 * Provider for forge's StructurePoolModifier system. See {@link IStructurePoolModifier} and {@link StructurePoolModifierSerializer}.
 *
 * This provider only requires implementing {@link #start()} and calling {@link #add} from it.
 */
public abstract class StructurePoolModifierProvider implements DataProvider
{
    private static final Gson GSON = new GsonBuilder().setPrettyPrinting().create();
    private final DataGenerator gen;
    private final String modid;
    private final Map<String, Tuple<StructurePoolModifierSerializer<?>, JsonObject>> toSerialize = new HashMap<>();
    private boolean replace = false;

    public StructurePoolModifierProvider(DataGenerator gen, String modid)
    {
        this.gen = gen;
        this.modid = modid;
    }
    ...
    /**
     * Sets the "replace" key in structure_pool_modifiers to true.
     */
    ...
    public void run(HashCache cache) throws IOException
    {
        ...
        Path forgePath = gen.getOutputFolder().resolve("data/forge/structure_pool_modifiers/structure_pool_modifiers.json");
        String modPath = "data/" + modid + "/structure_pool_modifiers/";
     ...
     */
    public <T extends IStructurePoolModifier> void add(String modifier, StructurePoolModifierSerializer<T> serializer, T instance)
    {
    ...
    {
        return "Structure Pool Modifiers : " + modid;
    }
