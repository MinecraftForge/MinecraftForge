...
public class ForgeBlockTagsProvider extends BlockTagsProvider
{
    ...
    public void addTags()
    {
        ...
        tag(GROWABLE).addTags(GROWABLE_BUSH, GROWABLE_CROP, GROWABLE_DEAD_BUSH, GROWABLE_FUNGUS, GROWABLE_NETHER_ROOTS, GROWABLE_NETHER_SPROUTS, GROWABLE_NETHER_WART, GROWABLE_STEM, GROWABLE_WITHER_ROSE);
        tag(GROWABLE_BUSH).add(Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL, Blocks.FARMLAND);
        tag(GROWABLE_CROP).add(Blocks.FARMLAND);
        tag(GROWABLE_DEAD_BUSH).addTags(SAND).add(Blocks.TERRACOTTA, Blocks.WHITE_TERRACOTTA, Blocks.ORANGE_TERRACOTTA, Blocks.MAGENTA_TERRACOTTA, Blocks.LIGHT_BLUE_TERRACOTTA, Blocks.YELLOW_TERRACOTTA, Blocks.LIME_TERRACOTTA, Blocks.PINK_TERRACOTTA, Blocks.GRAY_TERRACOTTA, Blocks.LIGHT_GRAY_TERRACOTTA, Blocks.CYAN_TERRACOTTA, Blocks.PURPLE_TERRACOTTA, Blocks.BLUE_TERRACOTTA, Blocks.BROWN_TERRACOTTA, Blocks.GREEN_TERRACOTTA, Blocks.RED_TERRACOTTA, Blocks.BLACK_TERRACOTTA, Blocks.DIRT, Blocks.COARSE_DIRT, Blocks.PODZOL);
        tag(GROWABLE_FUNGUS).addTags(GROWABLE_BUSH, BlockTags.NYLIUM).add(Blocks.MYCELIUM, Blocks.SOUL_SOIL);
        tag(GROWABLE_NETHER_ROOTS).addTags(GROWABLE_BUSH, BlockTags.NYLIUM).add(Blocks.SOUL_SOIL);
        tag(GROWABLE_NETHER_SPROUTS).addTags(GROWABLE_BUSH, BlockTags.NYLIUM).add(Blocks.SOUL_SOIL);
        tag(GROWABLE_NETHER_WART).add(Blocks.SOUL_SAND);
        tag(GROWABLE_STEM).add(Blocks.FARMLAND);
        tag(GROWABLE_WITHER_ROSE).addTags(GROWABLE_BUSH).add(Blocks.NETHERRACK, Blocks.SOUL_SAND, Blocks.SOUL_SOIL);
