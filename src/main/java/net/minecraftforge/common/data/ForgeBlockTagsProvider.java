...
public class ForgeBlockTagsProvider extends BlockTagsProvider
{
    ...
    public void registerTags()
    {
        ...
        func_240522_a_(MUSHROOMS).func_240534_a_(Blocks.BROWN_MUSHROOM, Blocks.RED_MUSHROOM, Blocks.BROWN_MUSHROOM_BLOCK, Blocks.RED_MUSHROOM_BLOCK, Blocks.MUSHROOM_STEM);
