...
public class BiomeTagsProvider extends ForgeRegistryTagsProvider<Biome>
{
    ...
    @Override
    protected void registerTags() //TODO Improve Tags for new Nether biomes
    {
        func_240522_a_(Tags.Biomes.HOT).add(Biomes.DESERT, Biomes.field_235254_j_, Biomes.DESERT_HILLS, Biomes.JUNGLE, Biomes.JUNGLE_HILLS, Biomes.JUNGLE_EDGE,
        ...
        func_240522_a_(Tags.Biomes.DRY).add(Biomes.DESERT, Biomes.field_235254_j_, Biomes.THE_END, Biomes.SMALL_END_ISLANDS, Biomes.END_MIDLANDS, Biomes.END_HIGHLANDS,
        ...
        func_240522_a_(Tags.Biomes.JUNGLE).add(Biomes.JUNGLE, Biomes.JUNGLE_HILLS, Biomes.JUNGLE_EDGE, Biomes.MODIFIED_JUNGLE, Biomes.MODIFIED_JUNGLE_EDGE);
        ...
        func_240522_a_(Tags.Biomes.HILLS).add(Biomes.MOUNTAINS, Biomes.DESERT_HILLS, Biomes.WOODED_HILLS, Biomes.TAIGA_HILLS, Biomes.JUNGLE_HILLS, Biomes.BIRCH_FOREST_HILLS,
                ...
                Biomes.TALL_BIRCH_FOREST, Biomes.GIANT_SPRUCE_TAIGA_HILLS, Biomes.SHATTERED_SAVANNA_PLATEAU, Biomes.MODIFIED_WOODED_BADLANDS_PLATEAU);
        ...
        func_240522_a_(Tags.Biomes.WASTELAND).add(Biomes.SNOWY_TUNDRA);
