 ...
 */
public class BlacksmithingRecipeBuilder
{
    ...
    public BlacksmithingRecipeBuilder(IRecipeSerializer<?> type, Ingredient base, Ingredient addition, ItemStack result, int cost)
    {
        this.type = type;
        this.base = base;
    ...
    public static BlacksmithingRecipeBuilder blacksmithing(Ingredient base, Ingredient addition, ItemStack result, int cost)
    {
        return new BlacksmithingRecipeBuilder(BlacksmithingRecipe.SERIALIZER, base, addition, result, cost);
    }
    
    public BlacksmithingRecipeBuilder unlocks(String key, ICriterionInstance criterion) 
    {
    ...
    public void save(Consumer<IFinishedRecipe> recipe, ResourceLocation location) 
    {
        ...
        recipe.accept(new BlacksmithingRecipeBuilder.Result(location, this.type, this.base, this.addition, this.result, this.cost, this.advancement, new ResourceLocation(location.getNamespace(), "recipes/" + this.result.getItem().getItemCategory().getRecipeFolderName() + "/" + location.getPath())));
    }
    ...
    public static class Result implements IFinishedRecipe 
    {
        ...
        public Result(ResourceLocation id, IRecipeSerializer<?> type, Ingredient base, Ingredient addition, ItemStack result, int cost, Advancement.Builder advancement, ResourceLocation advancementId) {
            this.id = id;
            this.type = type;
            this.base = base;
            this.addition = addition;
        ...
        public void serializeRecipeData(JsonObject tag) 
        {
            ...
            tag.addProperty("cost", this.cost);
        }
