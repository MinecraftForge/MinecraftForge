...
public record VanillaAnvilRecipe(ResourceLocation id) implements IAnvilRecipe
{
    ...
    public boolean matches(final ContainerWrapper container, final Level p_44003_)
    {
        ...
        if (!itemstack2.isEmpty()) {
            if (!net.minecraftforge.common.ForgeHooks.onAnvilChange(container.getMenu(), itemstack, itemstack2, container.getResultSlots(), container.getItemName(), j, container.getPlayer())) return false;
