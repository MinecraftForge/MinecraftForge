...
public class ForgeMod
{
    ...
    public ForgeMod()
    {
        ...
        ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, ForgeConfig.commonSpec); //TODO: Remove in 1.20 unless it is required outside of the use of Resource Caching.
