...
//        DimensionManager.processScheduledDeletions(levelSave);
    ...
    public void registerFluids(RegistryEvent.Register<Fluid> event)
    {
        ...
        {
            // set up attributes
            FluidAttributes.Builder attributesBuilder = FluidAttributes.builder(new ResourceLocation(ID, "block/milk_still"), new ResourceLocation("forge", "block/milk_flowing")).density(1024).viscosity(1024);
    ...
    public void registerLootData(RegistryEvent.Register<GlobalLootModifierSerializer<?>> event)
    {
        ...
        Registry.register(Registry.LOOT_CONDITION_TYPE, new ResourceLocation(ID, "can_tool_perform_action"), CanToolPerformAction.LOOT_CONDITION_TYPE);
    }
