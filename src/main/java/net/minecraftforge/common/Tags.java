...
public class Tags
{
    ...
    public static class Biomes
    {
        ...
        public static final IOptionalNamedTag<ResourceKey<Biome>> PEAKS = tag("peaks");
        ...
        public static final IOptionalNamedTag<ResourceKey<Biome>> SLOPES = tag("slopes");
        ...
        public static final IOptionalNamedTag<ResourceKey<Biome>> OVERWORLD_SURFACE = tag("overworld/surface");
        public static final IOptionalNamedTag<ResourceKey<Biome>> OVERWORLD_UNDERGROUND = tag("overworld/underground");
