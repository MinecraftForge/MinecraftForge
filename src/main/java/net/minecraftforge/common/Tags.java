...
public class Tags
{
    ...
    public static class Items
    {
        ...
        public static final Tag<Item> WEAPONS_SWORDS = tag("weapons/swords");
        ...
        public static final Tag<Item> WEAPONS_TRIDENTS = tag("weapons/tridents");

        public static final Tag<Item> TOOLS = tag("tools");
        public static final Tag<Item> TOOLS_HOES = tag("tools/hoes");
        public static final Tag<Item> TOOLS_HOES_WOODEN = tag("tools/hoes/wooden");
        public static final Tag<Item> TOOLS_HOES_STONE = tag("tools/hoes/stone");
        public static final Tag<Item> TOOLS_HOES_IRON = tag("tools/hoes/iron");
        public static final Tag<Item> TOOLS_HOES_GOLDEN = tag("tools/hoes/golden");
        public static final Tag<Item> TOOLS_HOES_DIAMOND = tag("tools/hoes/diamond");
        public static final Tag<Item> TOOLS_AXES = tag("tools/axes");
        public static final Tag<Item> TOOLS_AXES_WOODEN = tag("tools/axes/wooden");
        public static final Tag<Item> TOOLS_AXES_STONE = tag("tools/axes/stone");
        public static final Tag<Item> TOOLS_AXES_IRON = tag("tools/axes/iron");
        public static final Tag<Item> TOOLS_AXES_GOLDEN = tag("tools/axes/golden");
        public static final Tag<Item> TOOLS_AXES_DIAMOND = tag("tools/axes/diamond");
        public static final Tag<Item> TOOLS_PICKAXES = tag("tools/pickaxes");
        public static final Tag<Item> TOOLS_PICKAXES_WOODEN = tag("tools/pickaxes/wooden");
        public static final Tag<Item> TOOLS_PICKAXES_STONE = tag("tools/pickaxes/stone");
        public static final Tag<Item> TOOLS_PICKAXES_IRON = tag("tools/pickaxes/iron");
        public static final Tag<Item> TOOLS_PICKAXES_GOLDEN = tag("tools/pickaxes/golden");
        public static final Tag<Item> TOOLS_PICKAXES_DIAMOND = tag("tools/pickaxes/diamond");
        public static final Tag<Item> TOOLS_SHOVELS = tag("tools/shovels");
        public static final Tag<Item> TOOLS_SHOVELS_WOODEN = tag("tools/shovels/wooden");
        public static final Tag<Item> TOOLS_SHOVELS_STONE = tag("tools/shovels/stone");
        public static final Tag<Item> TOOLS_SHOVELS_IRON = tag("tools/shovels/iron");
        public static final Tag<Item> TOOLS_SHOVELS_GOLDEN = tag("tools/shovels/golden");
        public static final Tag<Item> TOOLS_SHOVELS_DIAMOND = tag("tools/shovels/diamond");
        public static final Tag<Item> TOOLS_SHEARS = tag("tools/shears");

        public static final Tag<Item> ARMOR = tag("armor");
        public static final Tag<Item> ARMOR_SHIELDS = tag("armor/shields");
        public static final Tag<Item> ARMOR_HELMETS = tag("armor/helmets");
        public static final Tag<Item> ARMOR_HELMETS_LEATHER = tag("armor/helmets/leather");
        public static final Tag<Item> ARMOR_HELMETS_IRON = tag("armor/helmets/iron");
        public static final Tag<Item> ARMOR_HELMETS_CHAINMAIL = tag("armor/helmets/chainmail");
        public static final Tag<Item> ARMOR_HELMETS_GOLDEN = tag("armor/helmets/golden");
        public static final Tag<Item> ARMOR_HELMETS_DIAMOND = tag("armor/helmets/diamond");
        public static final Tag<Item> ARMOR_CHESTPLATES = tag("armor/chestplates");
        public static final Tag<Item> ARMOR_CHESTPLATES_LEATHER = tag("armor/chestplates/leather");
        public static final Tag<Item> ARMOR_CHESTPLATES_IRON = tag("armor/chestplates/iron");
        public static final Tag<Item> ARMOR_CHESTPLATES_CHAINMAIL = tag("armor/chestplates/chainmail");
        public static final Tag<Item> ARMOR_CHESTPLATES_GOLDEN = tag("armor/chestplates/golden");
        public static final Tag<Item> ARMOR_CHESTPLATES_DIAMOND = tag("armor/chestplates/diamond");
        public static final Tag<Item> ARMOR_LEGGINGS = tag("armor/leggings");
        public static final Tag<Item> ARMOR_LEGGINGS_LEATHER = tag("armor/leggings/leather");
        public static final Tag<Item> ARMOR_LEGGINGS_IRON = tag("armor/leggings/iron");
        public static final Tag<Item> ARMOR_LEGGINGS_CHAINMAIL = tag("armor/leggings/chainmail");
        public static final Tag<Item> ARMOR_LEGGINGS_GOLDEN = tag("armor/leggings/golden");
        public static final Tag<Item> ARMOR_LEGGINGS_DIAMOND = tag("armor/leggings/diamond");
        public static final Tag<Item> ARMOR_BOOTS = tag("armor/boots");
        public static final Tag<Item> ARMOR_BOOTS_LEATHER = tag("armor/boots/leather");
        public static final Tag<Item> ARMOR_BOOTS_IRON = tag("armor/boots/iron");
        public static final Tag<Item> ARMOR_BOOTS_CHAINMAIL = tag("armor/boots/chainmail");
        public static final Tag<Item> ARMOR_BOOTS_GOLDEN = tag("armor/boots/golden");
        public static final Tag<Item> ARMOR_BOOTS_DIAMOND = tag("armor/boots/diamond");
