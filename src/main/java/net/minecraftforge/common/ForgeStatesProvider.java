...
public class ForgeStatesProvider implements IModStateProvider {
    ...
    final ModLoadingState CREATE_REGISTRIES     = ModLoadingState.withTransition("CREATE_REGISTRIES", "ADD_CUSTOM_DFU_FIXERS", ModLoadingPhase.GATHER, ForgeSerialModStateTransition.of(() -> Stream.of(IModStateTransition.EventGenerator.fromFunction(RegistryManager.newRegistryEventGenerator())), RegistryManager::preNewRegistryEvent, RegistryManager::postNewRegistryEvent));
