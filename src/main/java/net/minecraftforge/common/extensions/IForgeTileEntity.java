...
public interface IForgeTileEntity extends ICapabilitySerializable<CompoundNBT>
{
     ...
     */
      ...
      * Defaults to the collision bounding box {@link BlockState#getCollisionShape(net.minecraft.world.IBlockReader, BlockPos)} and {@link net.minecraft.util.math.shapes.VoxelShape#getBoundingBox()} associated with the block
      * at this location.
      *
