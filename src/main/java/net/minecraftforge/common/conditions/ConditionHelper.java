...
public class ConditionHelper {
	...
	public static final Map<ResourceLocation, IConditionSerializer<?>> conditions = new HashMap<>();
	...
	{
	    IConditionSerializer serializer = conditions.get(condition.getSerializerId());
	    if (serializer == null)
	    {
	...
	public static ICondition getCondition(JsonObject json)
	{
	    ...
	    IConditionSerializer<?> serializer = ConditionHelper.conditions.get(type);
	    if (serializer == null)
	 ...
	 * This method is "safe" in that it may not throw an exception for any reason.
