...
public class Constants
{
    ...
    public static class BlockFlags {
        public static final int NOTIFY_NEIGHBORS     = 0b00001; //1
        public static final int SEND_TO_CLIENTS      = 0b00010; //2
        public static final int NO_RERENDER          = 0b00100; //4
        public static final int RERENDER_MAIN_THREAD = 0b01000; //8
        public static final int NO_OBSERVERS         = 0b10000; //16
