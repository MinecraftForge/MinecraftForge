...
public class singularityI18n {
    ...
    static {
        ...
        customFactories.put("i18n", (name, formatString, locale) -> new CustomReadOnlyFormat((stringBuffer, o) -> stringBuffer.append(singularityI18n.parseMessage(formatString, o))));
        ...
        customFactories.put("ornull", ((name, formatString, locale) -> new CustomReadOnlyFormat((stringBuffer, o) -> stringBuffer.append(Objects.equals(String.valueOf(o),"null") ? singularityI18n.parseMessage(formatString) : String.valueOf(o)))));
    }
