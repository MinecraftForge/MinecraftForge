...
/**
 * Internal default implementation for {@link ObjectHolderRef}.
 */
class DefaultObjectHolderRef implements ObjectHolderRef
{
    private Field field;
    ...
    DefaultObjectHolderRef(Field field, ResourceLocation injectedObject, boolean extractFromExistingValues)
    {
        registry = ObjectHolderRef.getRegistryForType(field.getType());
