...
public class GameData
{
    ...
    public static void init()
    {
        ...
        makeRegistry(CONFIGURED_FEATURES, c(ConfiguredFeature.class)).addCallback(FeatureCallbacks.INSTANCE).disableSaving().create();
        ...
        makeRegistry(CONFIGURED_STRUCTURE_FEATURES, c(StructureFeature.class)).disableSaving().disableSync().create();
