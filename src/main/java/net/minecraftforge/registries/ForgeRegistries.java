...
public class ForgeRegistries
{
    ...
    static final DeferredRegister<Codec<? extends LoadingCondition>> DEFERRED_CONDITION_SERIALIZERS = DeferredRegister.create(Keys.CONDITION_SERIALIZERS, Keys.CONDITION_SERIALIZERS.location().getNamespace());
    /**
     * Calling {@link Supplier#get()} before {@link NewRegistryEvent} is fired will result in a null registry returned.
     * Use {@link Keys#CONDITION_SERIALIZERS} to create a {@link DeferredRegister}.
     */
    public static final Supplier<IForgeRegistry<Codec<? extends LoadingCondition>>> CONDITION_SERIALIZERS = DEFERRED_CONDITION_SERIALIZERS.makeRegistry(() -> new RegistryBuilder<Codec<? extends LoadingCondition>>().disableSaving().disableSync());
    ...
    public static final class Keys {
        ...
        public static final ResourceKey<Registry<Codec<? extends LoadingCondition>>> CONDITION_SERIALIZERS = key("forge:condition_serializers");
