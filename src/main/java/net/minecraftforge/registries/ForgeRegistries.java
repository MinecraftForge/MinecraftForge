...
public class ForgeRegistries
{
    ...
    public static final IForgeRegistry<IGlobalLootModifierSerializer<?>> LOOT_MODIFIER_SERIALIZERS = RegistryManager.ACTIVE.getRegistry(IGlobalLootModifierSerializer.class);
