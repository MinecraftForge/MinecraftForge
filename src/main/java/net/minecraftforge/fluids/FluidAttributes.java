...
public class FluidAttributes
{
    ...
    /**
     * Called instead of placing the fluid block if {@link net.minecraft.world.dimension.Dimension#doesWaterVaporize()} and {@link #doesVaporize(ILightReader, BlockPos, FluidStack)} are true.
