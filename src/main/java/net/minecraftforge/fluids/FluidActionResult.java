 ...
 *
 * Failed actions will always have {@link #isSuccess()} == false and a null result. See {@link #FAILURE}.
 *
 * Successful actions will always have {@link #isSuccess()} == true.
 * Successful actions may have a null result in some cases,
...
public class FluidActionResult
{
	...
	public FluidActionResult(@Nullable ItemStack result)
	{
		this(true, result);
	}

	private FluidActionResult(boolean success, @Nullable ItemStack result)
	{
