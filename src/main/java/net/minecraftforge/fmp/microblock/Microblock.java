...
public abstract class Microblock extends Multipart implements IMicroblock, IRedstonePart, ISlottedRedstonePart
{
    ...
    public static final IUnlistedProperty<Integer> PROPERTY_SIZE = new PropertyAdapter<Integer>(PropertyInteger.create("size", 0, 7));
    public static final IUnlistedProperty<PartSlot> PROPERTY_SLOT = new PropertyAdapter<PartSlot>(PropertyEnum.create("slot", PartSlot.class));
