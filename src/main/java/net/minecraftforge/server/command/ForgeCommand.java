...
public class ForgeCommand extends CommandBase {
    ...
    public ForgeCommand(MinecraftServer server)
    {
        ...
        CommandHandlerForge.doPermissionReg(this.getCommandName(), "forge.command", RegisteredPermValue.OP2);
        CommandHandlerForge.doPermissionReg(this.getCommandName(), "forge.tps", RegisteredPermValue.OP2);
        CommandHandlerForge.doPermissionReg(this.getCommandName(), "forge.track", RegisteredPermValue.OP2);
    }
