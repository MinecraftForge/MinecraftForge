 ...
 */
@NullMarked
public record AddFramePassEvent() implements IModBusEvent, RecordEvent {
    public static EventBus<AddFramePassEvent> getBus(BusGroup modBusGroup) {
        return IModBusEvent.getBus(modBusGroup, AddFramePassEvent.class);
    }
     ...
     */
    public void addPass(ResourceLocation rl, FramePassManager.ForgePassDefinition definition) {
