 ...
 */
@Cancelable
public class MouseInputProcessingEvent extends Event 
{
    ...
    public MouseInputProcessingEvent(float camFilterX, float camFilterY, float partialTicks, float pitch, float yaw)
    {
