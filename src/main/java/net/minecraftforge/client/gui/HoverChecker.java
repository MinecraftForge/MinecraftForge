...
public class HoverChecker
{
    ...
    {
        if (this.widget != null) {
            this.top = widget.field_230691_m_;
            this.bottom = widget.field_230691_m_ + widget.getHeight();
            this.left = widget.field_230690_l_;
            this.right = widget.field_230690_l_ + widget.func_230998_h_();
            canHover = canHover && widget.field_230694_p_;
        }
