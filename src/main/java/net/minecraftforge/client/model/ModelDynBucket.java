...
public final class ModelDynBucket implements IModel
{
                                    ...
                                    Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter)
    {
        ...
        if (liquidLocation != null && fluidSprite != null)
        {
            ...
            builder.addAll(ItemTextureQuadConverter.convertTexture(format, transform, liquid, fluidSprite, NORTH_Z_FLUID, EnumFacing.NORTH, tint ? fluid.getColor() : ~0, 1));
            builder.addAll(ItemTextureQuadConverter.convertTexture(format, transform, liquid, fluidSprite, SOUTH_Z_FLUID, EnumFacing.SOUTH, tint ? fluid.getColor() : ~0, 1));
