...
public class FramePassManager {
     ...
     * <ol>
     * <li>The rendering order for the purpose of translucency sorting. Read further for specific details.</li>
     * <li>A render state definition supplier; "what" will be rendered</li>
     * <li>A render state definition consumer; "how" it will be rendered</li>
     *</ol>
     * <p> </p>
