...
public interface IForgeRenderChunk
{
     ...
     * @param subtract Padding used internally by the ChunkRenderCache constructor to make
     *                 the cache a 20x20x20 cube, for a total of 8000 states in the cache.
     * @return new ChunkRenderCache instance
     */
