...
public class ForgeEventFactory
{
    ...
    public static List<String> fireSignChange(Player player, ServerLevel serverLevel, BlockPos pos, String[] lines)
    {
        ...
        PlayerEvent.SignChangeEvent signChangeEvent = new PlayerEvent.SignChangeEvent(player, serverLevel, pos, Arrays.asList(lines));
