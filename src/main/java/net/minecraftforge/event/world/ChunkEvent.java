...
public class ChunkEvent extends WorldEvent
{
     ...
     * {@link net.minecraft.world.server.ChunkManager#func_219200_b(ChunkHolder)} (IChunk)}<br>
     * <br>
    ...
    /**
     * Fired when vanilla Minecraft attempts to unload a Chunk from the world.<br>
     * This event is fired during chunk unloading in <br>
     * <br>
     * {@link net.minecraft.world.server.ChunkManager#scheduleSave} and <br>
     * {@link net.minecraft.client.multiplayer.ClientChunkProvider#unloadChunk(int, int)}. <br>
     * <br>
     * This event is not {@link net.minecraftforge.eventbus.api.Cancelable}.<br>
     * <br>
     * This event does not have a result. {@link HasResult} <br>
