 ...
 * {@link net.minecraftforge.common.extensions.IForgeWorld.playSoundFromEntityplaySoundFromEntity(Entity, double, double, double, SoundEvent, SoundCategory, float, float)}.<br>
 * <br>
