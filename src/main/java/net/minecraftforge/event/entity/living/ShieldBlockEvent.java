 ...
 * Note: The shield item stack "should" be available from {@link LivingEntity#getActiveItemStack()}
...
public class ShieldBlockEvent extends LivingEvent
{
    ...
    /**
     * Controls if {@link LivingEntity#damageShield(float)} is called.
    ...
    {
        this.dmgBlocked = MathHelper.clamp(blocked, 0, this.originalBlocked);
    }
