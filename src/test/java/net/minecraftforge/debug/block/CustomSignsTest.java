...
public class CustomSignsTest
{
    ...
    public static final RegistryObject<Block> TEST_STANDING_SIGN = BLOCKS.register("test_sign", () -> new StandingSignBlock(Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD), CustomSignsTest.TEST_WOOD_TYPE));
    public static final RegistryObject<Block> TEST_WALL_SIGN = BLOCKS.register("test_wall_sign", () -> new WallSignBlock(Properties.of(Material.WOOD).noCollission().strength(1.0F).sound(SoundType.WOOD), CustomSignsTest.TEST_WOOD_TYPE));
