...
public class MilkFluidTest
{
  ...
  private static void useMilk(PlayerInteractEvent event)
  {
    ...
    {
      FluidUtil.getFluidContainedInItem(stack).ifPresent((fluid) -> event.getPlayer().displayClientMessage(new StringTextComponent("Contains ").append(fluid.getDisplayName()), true));
    }
  }
}
