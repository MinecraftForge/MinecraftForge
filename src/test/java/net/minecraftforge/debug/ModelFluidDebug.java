...
public class ModelFluidDebug
{
    ...
    public static final Fluid milkFluid = new Fluid("milk", new ResourceLocation(ForgeModContainer.MOD_ID, "blocks/milk_still"), new ResourceLocation(ForgeModContainer.MOD_ID, "blocks/milk_flow"));
