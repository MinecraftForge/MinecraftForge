...
{
    // TODO-PATCHING: find what changed to world loading to see what gets passed to ForgeWorldPreset -sci
...
//            //         super.init();
//            //
//            //         addRenderableWidget(new Button(0, 0, 120, 20, Component.literal("close"), btn -> {
