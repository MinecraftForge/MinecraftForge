...
public class ClientCommandTest
{
    ...
    private static class TestCommand implements Command<ISuggestionProvider>
    {
        ...
        {
            Minecraft.getInstance().player.sendMessage(new StringTextComponent("Input: " + commandContext.getArgument("block", ResourceLocation.class).toString()), Util.field_240973_b_);
            return 0;
        }
    }
}
