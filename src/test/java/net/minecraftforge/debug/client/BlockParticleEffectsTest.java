...
import static net.minecraftforge.debug.client.BlockParticleEffectsTest.MOD_ID;
import static net.minecraftforge.debug.client.BlockParticleEffectsTest.MOD_NAME;
