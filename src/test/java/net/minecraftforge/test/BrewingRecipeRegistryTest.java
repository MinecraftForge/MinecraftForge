...
public class BrewingRecipeRegistryTest 
{
    ...
    public void init(FMLInitializationEvent event) 
    {
        ...
        ItemStack output0 = BrewingRecipeRegistry.getOutput(new ItemStack(Items.diamond_sword), new ItemStack(Items.rotten_flesh), null, null, null);
        ...
        ItemStack output1 = BrewingRecipeRegistry.getOutput(new ItemStack(Items.golden_sword), new ItemStack(Items.diamond), null, null, null);
        ...
        ItemStack output2 = BrewingRecipeRegistry.getOutput(new ItemStack(Items.potionitem, 1, 0), new ItemStack(Items.nether_wart), null, null, null);
