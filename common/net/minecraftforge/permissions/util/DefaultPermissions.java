...
public final class DefaultPermissions {
    private static final String ROOT = "forge";
    private static final String LEGACY_PREFIX = "forge";
    ...
    public static Permission registerPermission(Permission perm, boolean withLegacy) {
        ...
        try {
            ForgePermissionManager.addPermission(perm);
        } catch (IllegalArgumentException ex) {
            result = ForgePermissionManager.getPermission(perm.getName());
        }
