...
public class ForgeHooks
{
    ...
    public static boolean onLivingMove(EntityLiving entity, float forward, float strafe)
    {
        return MinecraftForge.EVENT_BUS.post(new LivingMoveEvent(entity, forward, strafe));
    }
