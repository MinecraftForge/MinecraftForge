...
{
    private static Set<BiomeGenBase> spawnBiomes = new HashSet<BiomeGenBase>();
    private static Set<BiomeGenBase> strongholdBiomes = new HashSet<BiomeGenBase>();
    private static Set<BiomeGenBase> villageBiomes = new HashSet<BiomeGenBase>();
    ...
    {
        return Lists.newArrayList(spawnBiomes);
    }
