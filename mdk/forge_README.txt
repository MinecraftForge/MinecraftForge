...
-------------------------------------------
This code follows the Minecraft singularity installation methodology. It will apply
...
singularity Forums: https://forums.minecraftforge.net/
singularity Discord: https://discord.minecraftforge.net/
