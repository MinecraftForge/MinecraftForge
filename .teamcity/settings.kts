...
project {
    ...
    params {
        ...
        password("env.CROWDIN_KEY", "credentialsJSON:dfdc0764-ae34-4ce2-972b-6e9ce730cbd2", display = ParameterDisplay.HIDDEN, readOnly = true) //This is a reference and not actually a key.
